...
{
    public partial class ServiceContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public virtual DbSet<TbMobileLogo> TbMobileLogos { get; set; }
        public virtual DbSet<TbSomeLogo> TbSomeLogos { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TbMobileLogo>(entity =>
            {
                ...
                entity.ToTable("TbMobileLogo");

                entity.HasIndex(e => e.LogoId, "IX_TbMobileLogo")
                    .IsUnique();

                entity.Property(e => e.LogoId).ValueGeneratedNever();
            ...
            modelBuilder.Entity<TbSomeLogo>(entity =>
            {
                entity.HasKey(e => e.LogoId);
            ...
            modelBuilder.Entity<TbItemDiscount>(entity =>
            {
                ...
                entity.HasIndex(e => e.ItemId, "IX_TbItemDiscount_1")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Item)
                    ...
                    .HasForeignKey(d => d.ItemId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_TbItemDiscount_TbItem");
            });
