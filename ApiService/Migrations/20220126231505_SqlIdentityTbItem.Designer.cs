...
namespace ApiService.Migrations
{
    ...
    [Migration("20220126231505_SqlIdentityTbItem")]
    partial class SqlIdentityTbItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiService.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ApiService.Models.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("ApiService.Models.TbCustomer", b =>
                {
            ...
            modelBuilder.Entity("ApiService.Models.TbDeliveryMan", b =>
                {
            ...
            modelBuilder.Entity("ApiService.Models.TbImage", b =>
                {
            ...
            modelBuilder.Entity("ApiService.Models.TbItem", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApiService.Models.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("ApiService.Models.TbMobileLogo", b =>
                {
                    ...
                    b.HasIndex(new[] { "LogoId" }, "IX_TbMobileLogo")
                        .IsUnique();

                    b.ToTable("TbMobileLogo");
                });

            modelBuilder.Entity("ApiService.Models.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("ApiService.Models.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("ApiService.Models.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiService.Models.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiService.Models.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("ApiService.Models.TbSomeLogo", b =>
                {
                    b.Property<int>("LogoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TbSomeLogos");
                });

            modelBuilder.Entity("ApiService.Models.TbSubCategory", b =>
                {
                    b.Property<int>("SubCategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiService.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiService.Models.TbImage", b =>
                {
                    b.HasOne("ApiService.Models.TbItem", "Item")
                        .WithMany("TbImages")
            ...
            modelBuilder.Entity("ApiService.Models.TbItem", b =>
                {
                    b.HasOne("ApiService.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_TbItem_TbCategory")
                        .IsRequired();

                    b.HasOne("ApiService.Models.TbSubCategory", "SubCategory")
                        .WithMany("TbItems")
            ...
            modelBuilder.Entity("ApiService.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("ApiService.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("ApiService.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("ApiService.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("ApiService.Models.TbSalesInvoice", b =>
                {
                    b.HasOne("ApiService.Models.TbCustomer", "Customer")
                        .WithMany("TbSalesInvoices")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_TbSalesInvoice_TbCustomer")
                        .IsRequired();

                    b.HasOne("ApiService.Models.TbDeliveryMan", "DeliveryMan")
                        .WithMany("TbSalesInvoices")
            ...
            modelBuilder.Entity("ApiService.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("ApiService.Models.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ApiService.Models.ApplicationUser", null)
                        .WithMany()
